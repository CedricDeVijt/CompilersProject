...
class DotGenerator:
    ...
    @staticmethod
    def generateSymbolTableDot(symbol_table, output_filename, format="dot"):
        """
        Generate a dot image from the symbol table and save it to a file.
        """
        dot = Digraph()
        DotGenerator._generateSymbolTableDot(dot, symbol_table)
