...
def test_complex_binary_modulo_test():
    source_file = "p1_complex_binary_modulo_test.c"
    mips_output_compare(root, source_file)


def test_complex_binary_operations_test():
    source_file = "p1_complex_binary_operations_test.c"
    mips_output_compare(root, source_file)


def test_complex_bitwise_operations_test():
    source_file = "p1_complex_bitwise_operations_test.c"
    mips_output_compare(root, source_file)


def test_complex_comparison_extended_test():
    source_file = "p1_complex_comparison_extended_test.c"
    mips_output_compare(root, source_file)


def test_complex_comparison_operations_test():
    source_file = "p1_complex_comparison_operations_test.c"
    mips_output_compare(root, source_file)


def test_complex_logical_operations_test():
    source_file = "p1_complex_logical_operations_test.c"
    mips_output_compare(root, source_file)


def test_complex_mixed_operations_test():
    source_file = "p1_complex_mixed_operations_test.c"
    mips_output_compare(root, source_file)


def test_complex_parenthesis_test():
    source_file = "p1_complex_parenthesis_test.c"
    mips_output_compare(root, source_file)


def test_complex_shift_operations_test():
    source_file = "p1_complex_shift_operations_test.c"
    mips_output_compare(root, source_file)


def test_complex_unary_operations_test():
    source_file = "p1_complex_unary_operations_test.c"
    mips_output_compare(root, source_file)
