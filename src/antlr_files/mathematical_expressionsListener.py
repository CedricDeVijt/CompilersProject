...
class mathematical_expressionsListener(ParseTreeListener):
    ...
    # Enter a parse tree produced by mathematical_expressionsParser#program.
    def enterProgram(self, ctx:mathematical_expressionsParser.ProgramContext):
        pass

    # Exit a parse tree produced by mathematical_expressionsParser#program.
    def exitProgram(self, ctx:mathematical_expressionsParser.ProgramContext):
        pass
