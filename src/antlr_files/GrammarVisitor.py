...
class GrammarVisitor(ParseTreeVisitor):
    ...
    # Visit a parse tree produced by GrammarParser#structStatement.
    def visitStructStatement(self, ctx:GrammarParser.StructStatementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GrammarParser#structVariable.
    def visitStructVariable(self, ctx:GrammarParser.StructVariableContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GrammarParser#structVariableDefinition.
    def visitStructVariableDefinition(self, ctx:GrammarParser.StructVariableDefinitionContext):
        return self.visitChildren(ctx)
    ...
    def visitStructAssignment(self, ctx:GrammarParser.StructAssignmentContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GrammarParser#structPostFixIncrement.
    def visitStructPostFixIncrement(self, ctx:GrammarParser.StructPostFixIncrementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GrammarParser#structPostFixDecrement.
    def visitStructPostFixDecrement(self, ctx:GrammarParser.StructPostFixDecrementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GrammarParser#structPreFixIncrement.
    def visitStructPreFixIncrement(self, ctx:GrammarParser.StructPreFixIncrementContext):
        return self.visitChildren(ctx)


    # Visit a parse tree produced by GrammarParser#structPreFixDecrement.
    def visitStructPreFixDecrement(self, ctx:GrammarParser.StructPreFixDecrementContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by GrammarParser#char.
    def visitChar(self, ctx:GrammarParser.CharContext):
        return self.visitChildren(ctx)
    ...
    # Visit a parse tree produced by GrammarParser#arrayAssignment.
    def visitArrayAssignment(self, ctx:GrammarParser.ArrayAssignmentContext):
        return self.visitChildren(ctx)
